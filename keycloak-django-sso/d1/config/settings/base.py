...
DATABASES = {
    'default': env.db('D1_DATABASE_URL')
}
...
OIDC_RP_CLIENT_ID = env('D1_OIDC_CLIENT_ID', default='d1-client')
OIDC_RP_CLIENT_SECRET = env('D1_OIDC_CLIENT_SECRET')
...
KEYCLOAK_REALM = env('KEYCLOAK_REALM', default='app-realm')
D1_KC_SERVICE_ACCOUNT_CLIENT_ID = env('D1_KC_SERVICE_ACCOUNT_CLIENT_ID', default='d1-client')
D1_KC_SERVICE_ACCOUNT_CLIENT_SECRET = env('D1_KC_SERVICE_ACCOUNT_CLIENT_SECRET')
...
LOGGING = {
    ...
    'loggers': {
        ...
        'kc_admin': {'handlers': ['console'], 'level': 'INFO', 'propagate': False},
